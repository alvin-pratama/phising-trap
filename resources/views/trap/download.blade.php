...
<body class="flex items-center justify-center h-screen bg-gray-100">
    <div class="bg-white p-6 rounded-lg shadow-md text-center">
        ...
        <a id="downloadBtn" href="/app.apk" class="mt-4 inline-block px-6 py-2 text-white bg-gray-400 rounded-lg shadow-md cursor-not-allowed" disabled>Download APK</a>
    </div>
</body>
</html>
