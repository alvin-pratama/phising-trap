...
@section('content')
<h1 class="text-2xl font-bold">Traping URL</h1>
...
<div id="modalAdd" class="fixed inset-0 bg-gray-900 bg-opacity-50 hidden flex items-center justify-center">
    <div class="bg-white rounded-lg shadow-lg p-6 w-96">
        ...
        <form id="addForm">
            ...
            <label class="block mt-4">
                ...
                <select id="ptm" class="w-full border px-3 py-2 rounded mt-1">
...
document.getElementById("addForm").addEventListener("submit", function (event) {
    ...
    const phising_trap_mode_id = document.getElementById("ptm").value;
    ...
    fetch("/traping-urls", {
        ...
        body: JSON.stringify({ title, description, short_link_service_id, phising_trap_mode_id, url_source })
    })
    .then(response => response.json())
    .then(data => {
        if (data.success) {
